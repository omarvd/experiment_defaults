...
qualddg = lm(ddg_qual ~ forced_choice_s, data = dfddg)

summary(qualddg)

qualyahoo = lm(yahoo_qual ~ forced_choice_s, data = dfyahoo)

summary(qualyahoo)

qualgoogle = lm(google_qual ~ forced_choice_s, data = dfgoogle)
...
e2.plotbingq1 + e2.plotbingq5 + e2.plotgoogleq1 + e2.plotgoogleq5
```
